...
@Component({
  selector: 'josephus-interactive',
  standalone: true,
  imports: [RouterOutlet, CommonModule, FormsModule],
  templateUrl: './josephus-interactive.component.html',
  styleUrl: './josephus-interactive.component.scss'
})
export class JosephusInteractiveComponent {
